...
class Sspd extends CI_Controller
{
    ...
    {   
        ...
        $cari =[
				...
				'nik'=>@$_POST['nama_search_name'],
				'nopen'=>@$_POST['nama_search_name'],
    ...
    function print($nopen){
        ...
        foreach ($lembar as $key => $value) {
            ...
            //bawah header
            $pdf->SetFont('Arial','',11);
            $pdf->Cell(190,7,'BADAN KEUANGAN DAERAH (BKD) KOTA '.@$this->setting->kota_besar,'LTRB',1,'');
            ...
            $pdf->Cell(50,5,@$ttd->nama,'R',1,'C');

            $pdf->SetFont('Arial','',10);
            $pdf->Cell(45,5,'','LR',0,'C');
            $pdf->Cell(55,5,'','R',0,'C');
            $pdf->Cell(40,5,'','R',0,'C');
            $pdf->Cell(50,5,@$ttd->nip,'R',1,'C');
    ...
    public function komen()
    {
        ...
        $str = '<li class="media">
                      ...
                      <div class="media-body">
                        ...
                        <p style="font-size:8pt"><?=tanggal_indonesia(date("Y-m-d H:i:s")) ?></p>
