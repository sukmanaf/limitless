...
<div class="panel-body">
        ...
        <div class="col-md-3 " style=" padding:5px">
        <input type="text" class="form-control input" name="harga_search_name" id="harga_search_id" placeholder="Harga"  />
        </div>

        <div class="col-md-3 " style=" padding:5px">
        <input type="text" class="form-control input" name="updated_at_search_name" id="updated_at_search_id" placeholder="Updated At"  />
        </div>

        <div class="col-md-3 " style=" padding:5px">
        <input type="text" class="form-control input" name="keterangan_search_name" id="keterangan_search_id" placeholder="Keterangan"  />
        </div>
...
function hapus(v,event){
    ...
    if (r == true) {
        ...
        post_url = "<?php echo site_url('barang/delete/')?>"+v;
                ...
                if (response == 1){
                  ...
                  // $.growl.error({ message: "The kitten is attacking!" });
                    ...
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            url : '<?php echo site_url('barang/get_data') ?>',
                            type: 'POST',
                            data : {},
                            dataType : 'json',
                            }).done(function(response){ //
