...
<div class="panel-body">
        ...
        <input type="text" class="form-control input" name="status_search_name" id="status_search_id" placeholder="Status"  />
        </div>

        <div class="col-md-3 " style=" padding:5px;">
        <input type="text" class="form-control input" name="text_search_name" id="text_search_id" placeholder="Text"  />
        </div>

        <div class="col-md-3 " style=" padding:5px;">
        <input type="text" class="form-control input" name="class_search_name" id="class_search_id" placeholder="Class"  />
        </div>
...
function hapus(v,event){
    ...
    if (r == true) {
        ...
        post_url = "<?php echo site_url('status/delete/')?>"+v;
                ...
                if (response == 1){
                  ...
                  // $.growl.error({ message: "The kitten is attacking!" });
                    ...
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            url : '<?php echo site_url('status/get_data') ?>',
                            type: 'POST',
                            data : {},
                            dataType : 'json',
                            }).done(function(response){ //
