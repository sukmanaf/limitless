...
<div class="panel-body">
        ...
        <input type="text" class="form-control input" name="dari_search_name" id="dari_search_id" placeholder="Dari"  />
        </div>

        <div class="col-md-3 " style=" padding:5px;;float: right">
        <input type="text" class="form-control input" name="ke_search_name" id="ke_search_id" placeholder="Ke"  />
        </div>
...
function hapus(v,event){
    ...
    if (r == true) {
        ...
        post_url = "<?php echo site_url('alur/delete/')?>"+v;
                ...
                if (response == 1){
                  ...
                  // $.growl.error({ message: "The kitten is attacking!" });
                    ...
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            url : '<?php echo site_url('alur/get_data') ?>',
                            type: 'POST',
                            data : {},
                            dataType : 'json',
                            }).done(function(response){ //
