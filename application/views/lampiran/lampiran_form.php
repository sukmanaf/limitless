...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <a href="<?php echo site_url('lampiran') ?>" class="btn btn-danger"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
        </div>
...
function uploadImage(image) {
        ...
        $.ajax({
            url:'<?php echo site_url('lampiran/upload_summernote');?>', //URL submit
   ...
   $("#postForm").submit(function(event){
        ...
        $.ajax({
            ...
            setTimeout(function () {
                    window.location.replace('<?php echo site_url('lampiran') ?>')
                       
                    }, 2000);
                //    $.ajax({
                //              url:'<?php echo site_url('lampiran/do_upload');?>', //URL submit
                //              type:"post", //method Submit
