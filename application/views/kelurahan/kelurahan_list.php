...
<div class="panel-body">
        ...
        <input type="text" class="form-control input" name="kecamatan_id_search_name" id="kecamatan_id_search_id" placeholder="Kecamatan Id"  />
        </div>
...
function hapus(v,event){
    ...
    if (r == true) {
        ...
        post_url = "<?php echo site_url('kelurahan/delete/')?>"+v;
                ...
                if (response == 1){
                  ...
                  // $.growl.error({ message: "The kitten is attacking!" });
                    ...
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            url : '<?php echo site_url('kelurahan/get_data') ?>',
                            type: 'POST',
                            data : {},
                            dataType : 'json',
                            }).done(function(response){ //
