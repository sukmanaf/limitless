...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
                    <label class="control-label col-lg-2">kecamatan_id</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="kecamatan_id" name="kecamatan_id" value="<?php echo $kecamatan_id; ?>">
                    </div>
                </div>
        ...
        <a href="<?php echo site_url('kelurahan') ?>" class="btn btn-danger"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
        </div>
...
function uploadImage(image) {
        ...
        $.ajax({
            url:'<?php echo site_url('kelurahan/upload_summernote');?>', //URL submit
   ...
   $("#postForm").submit(function(event){
        ...
        $.ajax({
            ...
            setTimeout(function () {
                    window.location.replace('<?php echo site_url('kelurahan') ?>')
                       
                    }, 2000);
                //    $.ajax({
                //              url:'<?php echo site_url('kelurahan/do_upload');?>', //URL submit
                //              type:"post", //method Submit
