                    ...
                    <div class=\"input-group\">
                        ...
                        <span class=\"input-group-btn\">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href=\"<?php echo site_url('$c_url'); ?>\" class=\"btn btn-danger\">Reset</a>
                                    <?php
                                }
                            ?>
...
<div class=\"row\">
  <div class=\"col\">
    ...
    <div class=\"card card-small mb-4\">
      ...
      <div class=\"row\" style=\"margin-bottom: 10px\">
        <div class=\"col-md-4\" style=\"margin: 10px\">
            <a href="echo site_url().$this->uri->segment(1)./create" class=\"btn btn-primary\">create</a>
        ...
        <div class=\"col-md-3 text-right\">
            <form action="echo site_url('visimisi/index');" class=\"form-inline\" method=\"get\">
    ...
    <div class=\"card-body p-0 pb-3 text-center\" style=\"padding: 250px\">
        <div style=\"padding: 30px\">
            
        <table id=\"dtables\" class=\"display\"></table>
...
<script>
    ...
    function hapus(v){
        alert("echo site_url('suplier/delete/').'v'");
    }

    var dataeq;
    $(document).ready(function() {
        $.ajax({
            url : '<?php echo site_url('tab_sinarmas/get_data') ?>',
            type: 'POST',
            data : {},
            dataType : 'json',
